...
public var SapphireMainnetNodePub : [TorusNodePub] = [
...
public var SapphireDevnetNodePub : [TorusNodePub] = [
...
public func SapphireConfig ( network : Web3AuthNetwork) throws -> NodeDetails? {
    switch network {
    case .SAPPHIRE_MAINNET :
        return .init(
            _currentEpoch: "1",
            _torusNodeEndpoints: try getSSSEndpoints(network: Web3AuthNetwork.SAPPHIRE_MAINNET),
            _torusNodeSSSEndpoints: try getSSSEndpoints(network: Web3AuthNetwork.SAPPHIRE_MAINNET),
        _torusNodeRSSEndpoints: try getRSSEndpoints(network: Web3AuthNetwork.SAPPHIRE_MAINNET),
            _torusNodeTSSEndpoints: try getTSSEndpoints(network: Web3AuthNetwork.SAPPHIRE_MAINNET),
    ...
    case .SAPPHIRE_DEVNET :
        return .init(
            _currentEpoch: "1",
            _torusNodeEndpoints: try getSSSEndpoints(network: Web3AuthNetwork.SAPPHIRE_DEVNET),
            _torusNodeSSSEndpoints: try getSSSEndpoints(network: Web3AuthNetwork.SAPPHIRE_DEVNET),
            _torusNodeRSSEndpoints: try getRSSEndpoints(network: Web3AuthNetwork.SAPPHIRE_DEVNET),
            _torusNodeTSSEndpoints: try getTSSEndpoints(network: Web3AuthNetwork.SAPPHIRE_DEVNET),
            _torusIndexes: [1, 2, 3, 4, 5],
