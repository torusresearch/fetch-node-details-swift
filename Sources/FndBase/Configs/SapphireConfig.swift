...
public func SapphireConfig ( network : SapphireNetwork) throws -> AllNodeDetailsModel {
    ...
    case .SAPPHIRE_MAINNET :
        return .init(
            _currentEpoch: "1",
            _torusNodeEndpoints: try getSSSEndpoints(network: .sapphire(SapphireNetwork.SAPPHIRE_MAINNET)),
    ...
    case .SAPPHIRE_DEVNET :
        return .init(
            _currentEpoch: "1",
            _torusNodeEndpoints: try getSSSEndpoints(network: .sapphire(SapphireNetwork.SAPPHIRE_DEVNET)),
