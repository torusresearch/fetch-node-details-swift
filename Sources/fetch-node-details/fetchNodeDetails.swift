...
//    }
    ...
    private func setupWeb3() {
        ...
        let contractJsonABI = contractABIString.data(using: .utf8)!
        let contractAddress = try! EthereumAddress(hex: self.proxyAddress, eip55: true)
        // You can optionally pass an abiKey param if the actual abi is nested and not the top level element of the json
        // let contract = try web3.eth.Contrac
