...
public struct SampleOutputMainNet {
    ...
    var proxyAddress: String = "0xf20336e16B5182637f09821c27BDe29b0AFcfe80"
...
public struct SampleOutputRopsten {
    ...
    var proxyAddress: String = "0x6258c9d6c12ed3edda59a1a6527e469517744aa7"
    var torusNodeEndpoints = [
...
public struct SampleOutputPolygon {
    ...
    var proxyAddress: String = "0x9f072ba19b3370e512aa1b4bfcdaf97283168005"
    var torusNodeEndpoints = [
...
public struct SampleOutputAqua {
    var currentEpoch: BigUInt = 1
    var proxyAddress: String = "0x29dea82a0509153b91040ee13cDBba0f03efb625"
    var torusNodeEndpoints = [
